...
/*   Updated: 2024/04/29 16:47:20 by npaolett         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	m_rotate_right(t_cube *game, float move_speed)
{
	...
	game->dir_x = game->dir_x * cos(-move_speed) - game->dir_y
		* sin(-move_speed);
	game->dir_y = old_dir_x * sin(-move_speed) + game->dir_y * cos(-move_speed);
	old_plane_x = game->plane_x;
	game->plane_x = game->plane_x * cos(-move_speed) - game->plane_y
		* sin(-move_speed);
	game->plane_y = old_plane_x * sin(-move_speed) + game->plane_y
		* cos(-move_speed);
}
